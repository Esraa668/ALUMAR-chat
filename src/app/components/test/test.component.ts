...
export class TestComponent implements OnInit {
  ...
  slidesAr = [
    { text: ' المنتجات والخدمات', icon: '../../../assets/Frame.png' },
    { text: ' طلب عرض سعر', icon: '../../../assets/Layer_2.png' },
    { text: 'المواد المستخدمة  ', icon: '../../../assets/Layer_3.png' },
    { text: ' التركيب والصيانة', icon: '../../../assets/Layer_1.png' },
    { text: '  خدمة العملاء', icon: '../../../assets/line.png' },
  ];
